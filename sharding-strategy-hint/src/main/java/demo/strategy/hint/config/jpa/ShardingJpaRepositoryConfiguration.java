package demo.strategy.hint.config.jpa;


import static demo.strategy.hint.constant.JpaConstant.SHARDING_ENTITY_MANAGER_FACTORY_NAME;
import static demo.strategy.hint.constant.JpaConstant.SHARDING_ENTITY_MANAGER_NAME;
import static demo.strategy.hint.constant.JpaConstant.SHARDING_PERSISTENCE_UNIT_NAME;
import static demo.strategy.hint.constant.JpaConstant.SHARDING_TRANSACTION_MANAGER_NAME;

import demo.strategy.hint.ShardingConfiguration;
...
@EnableJpaRepositories(
    basePackages = "demo.strategy.hint.repository",
...
public class ShardingJpaRepositoryConfiguration {
  ...
  public LocalContainerEntityManagerFactoryBean entityManagerFactory(EntityManagerFactoryBuilder builder) {
    ...
    return builder.dataSource(shardingDatasource)
        ...
        .packages("demo.strategy.hint.model.entity")
